...
for text in train_df['review']:
    ...
    train_tokens.append(processed.split())
...
for text in test_df['review']:
    ...
    test_tokens.append(processed.split())
...
# 合并所有特征
train_features = np.hstack([train_w2v, train_tfidf, train_length, train_neg])
test_features = np.hstack([test_w2v, test_tfidf, test_length, test_neg])
